...
class crime:
    ...
    def Crime_bar():
        ...
        st.plotly_chart(fig1)  
        st.write("<h2 style='text-align:left; color:Tomato;'><b>It is showing the number of rape cases per year in the states of india. </b></h2>",unsafe_allow_html=True)  
        st.write("Despite being the capital of the country, it is clearly visible that Delhi has the highest number of rape cases per year thus making it an unsafe place for women to grow and flourish.<br>This forms a barrier to late night work schedules, coachings etc hence affecting the functioning of daily lives of females unlike males.",unsafe_allow_html=True)
        ...
        st.plotly_chart(fig2)
        st.write("<h2 style='text-align:left; color:Tomato;'><b>It is showing the Kidnapping and Abduction cases per year in the states of india. </b></h2>",unsafe_allow_html=True)  
        st.write("Delhi again has the highest cases of female kidnapping and abductions per year making it an unconducive place for women to move in the city which ultimately affects their education, workforce participation and efficiency too. <br> For proper functioning of a human it is important that they are free from fear of safety but unfortunately this is not the condition with women in the capital of the country and some other states too like Uttar Pradesh, Assam etc.",unsafe_allow_html=True)
        ...
        st.plotly_chart(fig4)
        st.write("<h2 style='text-align:left; color:Tomato;'><b>It is showing the  Assault on women with intent to outrage her modesty per year in the states of india. </b></h2>",unsafe_allow_html=True)  
        ...
        st.write("<h2 style='text-align:left; color:Tomato;'><b>It is showing the Cruelty by Husband or his Relatives per year in the  states of india. </b></h2>",unsafe_allow_html=True)  
